...
## miRNA settings {-}
```{r}
k = config[c("mir_genome_fasta", "mir_starts_allowed"), , drop = FALSE]
rownames(k) = c("mir_genome_fasta", "mir_starts_allowed")
kable(k, caption = "miRNA reference and allowed alignment starts")
```
